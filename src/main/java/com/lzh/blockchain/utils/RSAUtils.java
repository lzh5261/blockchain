package com.lzh.blockchain.utils;
...
public class RSAUtils {
     ...
     */
    public static void generateKeys(String algorithm , String publicKeyPath, String privateKeyPath) {
        try {
            // 密钥对生成器
     ...
     * @param publicKeyPath  : 保存公钥的文件路径
     */
    public static void generateKeysJS(String algorithm, String publicKeyPath, String privateKeyPath) {
        try {
            KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(algorithm);
